placeholder for you to update - Linux Mint as the host machine running Splunk Enterprise. Windows 11 in a virtualbox VM, running on the Linux Mint machine. 
